...
# OS images
image_raw = $(BUILD_DIR)/SabrinaOS.raw
image_raw_zip = $(BUILD_DIR)/SabrinaOS_raw.zip
image_vmdk = $(BUILD_DIR)/SabrinaOS.vmdk
image_vdi = $(BUILD_DIR)/SabrinaOS.vdi
